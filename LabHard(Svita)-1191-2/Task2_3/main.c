...
//}
		...
		for (uint16_t i = 9 ; i>6; i--){       
			if(d<12) {																																				//условие срабатывает, если десятичное число меньше разрядности
				text[i] = d;																																//в выходной массив записывается значение числа
				break;																																				//цикл прерывается
			}
			text[i] = d%12;																																//в выходной массив записывается остаток от деления на 12
			d = d/12;																																				//в число записывается целая часть от деления
		} 
