...
void InitUSART1(){
	...
	USART1->BRR= 208;																																		/*Настройка делителя частоты, тактирующего USART и задающего скорость приема и передачи данных на уровне 9600 бит/с: 
	...
	USART1->CR2 = 0x2000;																																		//Количество стоповых бит - 1
